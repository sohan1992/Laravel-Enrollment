                ...
                <div class="card-body overview">
                  ...
                  <div class="info-links">
                    <a class="website">Father Name:</i>
                      <span style="font-family: verdana">{{$student_profile->student_fathername}}</span>
                    </a>
                    <a class="website">Mother Name:</i>
                      <span style="font-family: verdana">{{$student_profile->student_mothername}}</span>
                    </a>
                    <a class="website">Address:</i>
                      <span style="font-family: verdana">{{$student_profile->student_address}}</span>
                    </a>
                    <a class="website">Department:</i>
                      <span style="font-family: verdana">
                      	{{convert_deparment($student_profile->student_department)}}
                      </span>
                    </a>
                    <a class="website">Admission Year:</i>
                      <span style="font-family: verdana">{{$student_profile->student_admissionyear}}</span>
                    </a>
